...
- Repository: `hoeken/signalk-sun-moon`
...
- [GitHub Actions](https://github.com/hoeken/signalk-sun-moon/actions) — the "Publish to npm" run is green
- [GitHub Releases](https://github.com/hoeken/signalk-sun-moon/releases) — the release shows your CHANGELOG notes
- [npm](https://www.npmjs.com/package/signalk-sun-moon) — the new version is live

Pre-release tags (`v1.1.0-beta.1`, `-alpha`, `-rc`) are marked as
