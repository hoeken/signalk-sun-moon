...
function sunNote(sun, which) {
  if (sun.polar && sun.polar.alwaysUp)
    return "Polar day: the sun does not " + which + " today.";
  if (sun.polar && sun.polar.alwaysDown)
    return "Polar night: the sun does not " + which + " today.";
