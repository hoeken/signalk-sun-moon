...
function moonNote(moon, which) {
  if (moon.polar && moon.polar.alwaysUp)
    return "The moon is above the horizon all day.";
  if (moon.polar && moon.polar.alwaysDown)
    return "The moon is below the horizon all day.";
